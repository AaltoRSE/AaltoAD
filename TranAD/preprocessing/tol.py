...
def load_TOL(folder, csv_path=None, data_folder=DEFAULT_DATA_FOLDER, top_k=10, train_seconds=300, calibration_seconds=60, test_seconds=480, valid_seconds=120, extended_features=False, anomaly_start_sec=480, anomaly_duration_sec=240):
